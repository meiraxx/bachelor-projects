// $Id: type_checker.h,v 1.10 2017/05/12 01:30:02 ist182014 Exp $ -*- c++ -*-
...
namespace xpl {
  ...
  protected:
    void processBinaryExpressionAdditive(cdk::binary_expression_node * const node, int lvl);
    void processBinaryExpressionMultiplicative(cdk::binary_expression_node * const node, int lvl);
    void processBinaryExpressionEquality(cdk::binary_expression_node * const node, int lvl);
    void processBinaryExpressionComparative(cdk::binary_expression_node * const node, int lvl);
    void processBinaryExpressionLogical(cdk::binary_expression_node * const node, int lvl);
    void processUnaryExpressionSignal(cdk::unary_expression_node * const node, int lvl);
