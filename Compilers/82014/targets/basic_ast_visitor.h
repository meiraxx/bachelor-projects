...
public:
  ...
  virtual void do_indexer_node(xpl::indexer_node * const node, int lvl) = 0;
  ...
  virtual void do_fundef_node(xpl::fundef_node * const node, int lvl) = 0;
  virtual void do_funcall_node(xpl::funcall_node * const node, int lvl) = 0;
  virtual void do_memaddr_node(xpl::memaddr_node * const node, int lvl) = 0;
