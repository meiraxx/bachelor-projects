...
namespace xpl {
  ...
  private:
    ...
    inline void typeToString(basic_type *type, int lvl) {
      if(type->name() == type->TYPE_INT){
         os() << std::string(lvl, ' ') + "INT" << std::endl;
      }
      else if(type->name() == type->TYPE_DOUBLE){
         os() << std::string(lvl, ' ') + "DOUBLE" << std::endl;
      }
      else if(type->name() == type->TYPE_STRING){
         os() << std::string(lvl, ' ') + "STRING" << std::endl;
      }
      else if(type->name() == type->TYPE_POINTER){
        os() << std::string(lvl, ' ') + "POINTER" << std::endl;
      }
      else if(type->name() == type->TYPE_VOID){
        os() << std::string(lvl, ' ') + "VOID" << std::endl;
      }
    }
